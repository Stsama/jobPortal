...
const supabaseClient = createClient(
  "https://wkdirpyznnogzrqnhxgc.supabase.co",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndrZGlycHl6bm5vZ3pycW5oeGdjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzE1MzkzNDgsImV4cCI6MjA0NzExNTM0OH0.Pd8wMh4ION5SeD_Pa2JwEnsF8kY97bDQormaW-SOaq"
      ...
      <div className="grid grid-cols-1 gap-3 p-10 md:grid-cols-2 lg:grid-cols-3">
        {jobApplications && jobApplications.length > 0
          ? jobApplications.map((jobApplicantItem) => (
              <div className="bg-white shadow-lg w-full max-w-sm rounded-lg overflow-hidden mx-auto mt-4" key={jobApplicantItem}>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-6">
                {currentCandidateDetails?.candidateInfo?.previousCompanies
                  .split(",")
                  .map((skillItem) => (
                    <div className="w-[100px] dark:bg-white flex justify-center items-center h-[35px] bg-black rounded-[4px]" key={skillItem}>

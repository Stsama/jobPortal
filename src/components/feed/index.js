...
const supabaseClient = createClient(
  ...
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndrZGlycHl6bm5vZ3pycW5oeGdjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMTUzOTM0OCwiZXhwIjoyMDQ3MTE1MzQ4fQ.eqd81lKoXOZdHKa_rIfPfmvpCTJuf4NWjdN766vFNI8"
...
function Feed({ user, profileInfo, allFeedPosts }) {
  ...
  async function handleUploadImageToSupabase() {
    console.log(imageData, imageData?.name)
